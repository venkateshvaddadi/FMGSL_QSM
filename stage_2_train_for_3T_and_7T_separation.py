...
# Your requested loss balance weights configuration
lambda_rec = 1.0           # Primary structural anchor mapping
lambda_dc  = 0.5           # Softened physical guardrail
lambda_sem = 0.5           # Aggressive domain macro-clustering push
...
for epoch in range(1, epochs + 1):
    ...
    for batch in progress_bar:
        ...
        chi_norm_pred = recon_net(b_norm)
        chi_3t_pred = chi_norm_pred * y_std + y_mean
        ...
        loss_rec = criterion_rec(chi_norm_pred, y_norm)   # Voxel regression in stable normalized space
